...
nn <- neuralnet(
  train.df$not_purchase + train.df$purchase ~ Topflight + Balance + Qual_miles + cc1_miles. + cc2_miles. +
...
```{r}
confusionMatrix(as.factor(nn.pred.class),
                as.factor(test.df$Phone_sale),
                positive = "1")
```
